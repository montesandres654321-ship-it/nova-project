...
* **App móvil** (`nova\\\_app/`) — la usa el TURISTA. Prioridad: simple, amigable, táctil.
* **Dashboard web** (`nova\\\_dashboard/`) — lo usan ADMINISTRADORES y la GOBERNACIÓN.
...
* Respetar las reglas técnicas de nova-flutter (no romper build, web\_build, etc.).
