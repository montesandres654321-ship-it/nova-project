...
const kAdminTextSub   = Color(0xFF94A3B8);
const kAdminBorder    = Color(0xFFE2E8F0);
const kAdminBlue      = Color(0xFF3B82F6);
const kAdminAmber     = Color(0xFFF59E0B);
const kAdminRed       = Color(0xFFEF4444);
const kAdminPurple    = Color(0xFF8B5CF6);
const kAdminGreen     = Color(0xFF10B981);
