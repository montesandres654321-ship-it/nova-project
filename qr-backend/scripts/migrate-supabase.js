...
//   DATABASE_URL=postgresql://... node scripts/migrate-supabase.js
// ============================================================
...
async function migrate() {
  ...
  console.log('\n🔨 NOVA APP — Migración Supabase PostgreSQL');
  ...
  try {
    ...
    console.log('\n' + '='.repeat(50));
    console.log('✅ Migración Supabase completada');
    console.log('   Siguiente: configurar variables en Railway y hacer deploy');
    console.log('='.repeat(50) + '\n');
...
migrate().catch(err => {
  console.error('❌ Migración abortada:', err.message);
  process.exit(1);
});
